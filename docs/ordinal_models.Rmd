...
A model that relaxes the proportional odds assumption--the generalized ordinal logit model--may be run using `oglmx::ologit.reg()`. This package is handy because it can also estimate things like heteroskedastic ordinal logit/probit models.
</div>